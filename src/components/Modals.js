export default function Modal(props) {
  const classNames = ["modal", props.show && "is-active"]
    .filter((e) => e)
    .join(" ");
    ...
    <div className={classNames}>
      ...
      <div className="w-max-25rem w-max-content modal-content">
        <div className="p-0 section">
          <div
            className="px-5 pt-2 pb-5 box is-flex is-flex-direction-column
                          is-justify-content-center is-align-items-center
                          has-text-centered"
          >
            <div className="my-3 is-size-4">{props.title}</div>

            <div className="is-size-6 has-text-centered">{props.text}</div>
